...
<%@ page import="com.dev.todo.app.model.Todo" %>
<%@ page import="com.dev.todo.app.dao.Dao" %>
...
if (user != null){
    ...
    if(request.getParameter("op") != null && request.getParameter("op").equalsIgnoreCase("ALL"))
    {	
    	System.out.println(request.getParameter("op"));
    	todos = dao.getAllTodos(user.getUserId());
    }	
    else 
...
<%-- <td>
<a class="done" href="/done?id=<%=todo.getId()%>" >Status</a>
</td> --%>
<td>
<a class="done" ><%=todo.getStatus()%></a>
</td>
<td>
<a class="done" href="/done?id=<%=todo.getId()%>&op=completed" >Completed</a>
</td>
<td>
<a class="done" href="/done?id=<%=todo.getId()%>&op=delete" >Delete</a>
</td>
</tr> 
<%}
%>
...
<a class="done" href="/TodoApplication.jsp?op=ALL" >All ToDo List...</a>
